    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   </div>",
                "   <div class=''>",
                "       <ul class='iscroll-wrapper select2-results' role='listbox'>",
                "       </ul>",
                "   <div>",
                "</div><script>$('.iscroll-wrapper').on('load', function() {console.log('loaded'); var scroller = new iScroll($('.iscroll-wrapper')[0])})</script>"].join(""));
            return container;
        },
